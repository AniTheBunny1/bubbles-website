...
const memories = [
  { text: "You mentioned your flight.", meta: "Three weeks ago.", left: "7%",  top: "12%", size: "text-2xl md:text-4xl",  opacity: 0.78, rotate: "-2deg" },
  { text: "Aisle seat. Always.",         left: "60%", top: "18%", size: "text-xl md:text-3xl",   opacity: 0.62, rotate: "2deg"  },
  { text: "Gaurav in ten minutes.",      meta: "Your notes are ready.", left: "20%", top: "38%", size: "text-3xl md:text-5xl",  opacity: 0.90, rotate: "1deg"  },
  ...
  return (
    <section ref={ref} className="relative z-10 min-h-[160vh] overflow-hidden px-5 py-32">
      <motion.p
        ...
        className="mx-auto max-w-2xl text-center text-5xl font-semibold tracking-tight text-black md:text-7xl"
      >
